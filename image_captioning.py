...
class ImageCaptioning:
    def __init__(self):
        self.model = VisionEncoderDecoderModel.from_pretrained("bipin/image-caption-generator")
        self.feature_extractor = ViTFeatureExtractor.from_pretrained("bipin/image-caption-generator")
